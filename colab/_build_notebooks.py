...
nb02 = [
    ...
    *CLONE_REPO_CELLS,
    ...
    code(
        "# Mind2Web (test_task split). 100 tasks ~= 8-15 min due to screenshot decode.",
        "!python scripts/prepare_mind2web.py --split test_task --out-dir {DATA}/mind2web --limit 100",
        "!ls {DATA}/mind2web && wc -l {DATA}/mind2web/test_task.jsonl",
    ),
    code(
