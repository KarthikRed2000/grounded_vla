...
nb02 = [
    ...
    code(
        "# Mind2Web (test_task split). 100 tasks ~= 8–15 minutes due to screenshot decoding.",
        "OUT = '/kaggle/working/gvla-data/mind2web'",
        "!python scripts/prepare_mind2web.py --split test_task --out-dir {OUT} --limit 100",
        "!ls {OUT} && wc -l {OUT}/test_task.jsonl",
    ),
    code(
...
nb03 = [
    ...
    code(
        ...
        "    return make_dataset({",
        "        'kind': 'mind2web',",
        "        'jsonl_path': f'{DATA}/mind2web/test_task.jsonl',",
